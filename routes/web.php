...
Route::get('/get-route/{key}', 'HomeController@getRoute')->name('get-route');
...
Route::group(['prefix'=>'muhasebe-vergi'],function (){
    ...
    Route::group(['prefix'=>'mali-tablolar'],function (){
        Route::get('/gelir-tablosu','MaliTabloController@gelirTablosu')->name('gelir-tablosu');
        Route::get('/bilanco','MaliTabloController@bilanco')->name('bilanco');
        Route::get('/nakit-akisi','MaliTabloController@nakitAkisi')->name('nakit-akisi');
        Route::get('/nakit-akisi-inner','MaliTabloController@nakitAkisiInner')->name('nakit-akisi-inner');
        Route::get('/nakit-akis-ust-kalem-get-order/{type}/{id?}','MaliTabloController@nakitAkisUstKalemGetOrder')->name('nakit-akisi-ust-kalem-get-order');
        Route::get('/nakit-akis-ust-kalem/{type}/{year}/{id?}','MaliTabloController@nakitAkisUstKalem')->name('nakit-akisi-ust-kalem');
        Route::post('/nakit-akis-ust-kalem/','MaliTabloController@nakitAkisUstKalem')->name('nakit-akisi-ust-kalem-post');

        Route::get('/alt-kalem/{ust_id}/{id?}','MaliTabloController@nakitAkisAltKalem')->name('nakit-akisi-alt-kalem');
        Route::post('/alt-kalem/','MaliTabloController@nakitAkisAltKalem')->name('nakit-akisi-alt-kalem-post');
