...
@section('main')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><a href="#"  onclick="window.open('{{route('client-update',[$client['id'],2])}}','_self')">{{$client['name']}}</a> &gt; {{__('admin.create_executive')}}</h2>
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" id="create-executive"
                          action="{{route('executive-create-post')}}" method="post"
...
@section('scripts')
    ...
    <script>
        ...
        $('#create-executive').submit(function (e) {
            e.preventDefault();
            var error = false;
            eps = 0;
            if ($('#name').val() == '') {
        ...
        function save(formData) {
            $.ajax({
                type: 'POST',
                url: '{{route('executive-create-post')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
