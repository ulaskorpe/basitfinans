...
<div class="bg-secondary" id="navbar_logo">
        <div class="container">
    <a class="navbar-brand pad" href="/"><img src="{{url('img/logo.png')}}" alt="" class="img-thumbnail mx-auto d-inline" style="max-width: 50px"><h1 class="d-inline ml-2">Basit Finans</h1></a>
        </div>
